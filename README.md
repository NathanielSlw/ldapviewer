...
<p>
  <strong>ldapviewer</strong> turns ldapdomaindump and adwsdomaindump .json exports into a modern, interactive, fully offline web interface for Active Directory pentesting.
  Unlike the default .html files generated by ldapdomaindump, <strong>ldapviewer</strong> displays every LDAP attribute so you never miss critical information.
</p>

<p>
  It also goes further, with dozens of AD-specific filters and attack icons (Kerberoasting, gMSA/dMSA, LAPS, ...), a security-focused statistics dashboard, and full DACL parsing that surfaces dangerous ACL grants (GenericAll, GenericWrite, ForceChangePassword...) directly from a static dump.
</p>
