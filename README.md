...
<h3 align="center">LDAP Viewer</h3>
  ...
  <p align="center">
    <strong>ldapviewer</strong> is a Python script to visualize <strong>all</strong> LDAP data from <strong>ldapdomaindump</strong> and <strong>adwsdomaindump</strong> .json files in a modern, interactive web interface.  
